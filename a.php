      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="Pets_form.php" class="nav-link">Home</a></li>
        ...
        <?php while($row = mysqli_fetch_assoc($result)) { ?>
          <tr>
           ...
           <td><?php echo $row['age']; ?></td>
            <td>
    <a href='Pets_form2.php?ID=<?php echo $row['ID']; ?>' class='btn btn-sm btn-warning'>Edit</a>
