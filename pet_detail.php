...
<html lang="en">
 ...
 box-shadow: 0 15px 30px rgba(0, 0, 0, 0.1);
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="Appoin.php" class="nav-link">Home</a></li>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="petform.php" class="btn btn-primary" name="save" value="create">
                  Create Admission
                </a>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="Appoin.php">Home</a></li>
   ...
   <h1 style="text-align: center;font-size: 40px;font-family: sans-serif; font-size: 30px;">Appointments.</h1>
    <?php
require('connect.php');
